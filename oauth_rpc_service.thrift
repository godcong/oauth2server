 ...
 * target languages.
 */
namespace cpp com.mana.oauth
namespace d com.mana.oauth
namespace dart com.mana.oauth
namespace java com.mana.oauth
namespace php com.mana.oauth
namespace perl com.mana.oauth
namespace haxe com.mana.oauth
namespace netcore com.mana.oauth
 ...
 */
enum Roles {
  RESOURCE_OWNER = 1, //资源拥有者
  CLIENT_APPLICATION = 2, //客户端应用
  RESOURCE_SERVER = 3, //资源服务器
  AUTHORIZATION_SERVER =4 //授权服务器
}
...
enum AuthorizationGrant{
  ...
  IMPLICIT = 2,
  RESOURCE_OWNER_PASSWORD_CREDENTIALS = 3,
...
enum AuthorizationErrorResponse{
error
error_description
error_uri
state
